...
namespace Itminus.Feature
{
    internal class KeyComparer : IEqualityComparer<KeyValuePair<Type, object>>
    {
    ...
    public class FeatureCollection : IFeatureCollection
    {
        ...
        public object this[Type key]
        {
            get
            {
                ...
                object result;
                return _features != null && _features.TryGetValue(key, out result) ? 
                    result : 
                    _defaults?[key];
            }
